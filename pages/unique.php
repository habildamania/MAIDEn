...
$que="SELECT timestamp, count(*) FROM visitors GROUP BY DAY(FROM_UNIXTIME(timestamp))";
...
?>    
	...
	$(function() {//SELECT timestamp, count(*) FROM visitors GROUP BY DAY(FROM_UNIXTIME(timestamp));
//, [1196550000000, 0]

		var d = [[1527970166000, 18],[1528142966000, 25],[<?php echo"$time, $count"; ?>]<?php  
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Unique Visitors</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3>Total Unique Visitors &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;  Maximum Unique Visitors &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;Minimum Unique Visitors</h3>
                           
                            <div class="row show-grid">
                                <div class="col-xs-6 col-md-4">183</div>
                                <div class="col-xs-6 col-md-4">50</div>

...
$que="SELECT count(*) FROM attack WHERE alert = 1";
...
$que="SELECT attack_name,count(*) FROM attack where alert = 1 group by attack_name order by count(*) desc";
$query=$mysqli_conn->query($que);
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Threats</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3>Total Threats &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;  Top Country &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;   Top Threat Type</h3>
                           
                            <div class="row show-grid">
                                <div class="col-xs-6 col-md-4"><?php echo $count  ?></div>
                                <div class="col-xs-6 col-md-4">N/A</div>
                                <div class="col-xs-6 col-md-4"><?php echo $attack  ?></div>
                            </div>
  ...
  function get_top_packet_table(){
	                            ...
	                            document.getElementById("top_placeholder").innerHTML =xmlhttp.responseText;
            ...
            responsive: true
                                        ...
                                        xmlhttp.open('GET','./ax/get_top_table.php', true);
                                            xmlhttp.send();
        }
get_top_packet_table();
